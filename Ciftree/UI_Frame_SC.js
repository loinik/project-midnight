...
var touchNavPressed = AR.Overlay({
    ovl: "UI_Frame_OVL",
...
var touchNavPressed_Button = AR.Button({
    hs: AR.Hotspot({
        ref: "UI_Frame_OVL",
        source: [686, 497, 937, 564],
        onScreen: [691, 697, 760, 764],
